# ======================================================================
# ILP - FULL RECONSTRUCTION OF assessment-service
# UTF-8 WITHOUT BOM (ABSOLUTELY NO BOM)
# ======================================================================
...
Write-NoBomFile "$BasePath/src/main/java/com/inclusive/assessmentservice/AssessmentServiceApplication.java" $Main
...
Write-NoBomFile "$BasePath/src/main/java/com/inclusive/assessmentservice/repository/AssessmentRepository.java" $Repo
...
Write-NoBomFile "$BasePath/src/main/java/com/inclusive/assessmentservice/service/impl/AssessmentServiceImpl.java" $Impl
...
Write-Host "==============================================="
Write-Host "ASSESSMENT SERVICE CREATED WITHOUT BOM ✔️"
