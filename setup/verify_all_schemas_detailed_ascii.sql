...
-- Autor: Inclusive Learning Platform - DevOps Integrity Module
-- Fecha: 2025-11-07
-- Descripción:
--   Auditoría avanzada de esquemas para:
--     - auth_service
--     - inclusive_learning
--     - adaptive_education_db
--   Diseño 100% compatible con entornos CI/CD y ejecución idempotente.
-- ==============================================================
...
\echo === Initializing helper functions in target databases ===

-- -----------------------------------------------------------
-- Create helper function in postgres
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- Create helper function in auth_service
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- Create helper function in inclusive_learning
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- Create helper function in adaptive_education_db
-- -----------------------------------------------------------
...
\connect postgres postgres
\echo === Helper functions ready in all target databases ===
