...
@Component
public class DivergentStrategy implements InferenceStrategy {
    @Override
    public boolean appliesTo(Map<String, Object> styles) {
        Object style = styles.get("kolb");
        return style != null && style.toString().equalsIgnoreCase("DIVERGENT");
    }
    @Override
    public String getStyleKey() { return "DIVERGENT"; }
}
