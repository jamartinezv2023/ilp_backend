package com.ilp.e2e.notification;
...
class NotificationPriorityCrudE2ETest {

    private static final String BASE_URL =
            System.getProperty("ilp.e2e.base-url",
                    System.getenv().getOrDefault("ILP_E2E_BASE_URL", "http://localhost:8080"));

    private static final String BASE_PATH = "/api/notification/notificationpriority";
    ...
    void create_shouldReturnSuccessOrValidationError() {
        // TODO: completar JSON vÃƒÂ¡lido para NotificationPriority
        String body = "{ }";
