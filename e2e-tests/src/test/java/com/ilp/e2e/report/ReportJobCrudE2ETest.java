...
class ReportJobCrudE2ETest {
    ...
    void create_shouldReturnSuccessOrValidationError() {
        // TODO: completar JSON vÃƒÂ¡lido para ReportJob
        String body = "{ }";
