package com.ilp.e2e.assessment;
...
class AssessmentCrudE2ETest {
    ...
    void create_shouldReturnSuccessOrValidationError() {
        // TODO: completar JSON vÃƒÂ¡lido para Assessment
        String body = "{ }";
