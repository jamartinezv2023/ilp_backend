package com.ilp.e2e.adaptiveeducation;
...
class StudentCrudE2ETest {
    ...
    void create_shouldReturnSuccessOrValidationError() {
        // TODO: completar JSON vÃƒÂ¡lido para Student
        String body = "{ }";
